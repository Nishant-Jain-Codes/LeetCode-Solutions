...
class Solution
{
     ...
     Node *copyList(Node *head)
    {
        ...
        // Create a map to store the original and copied nodes
        unordered_map<Node*, Node*> mp;

        // Create the copy of the head node and add it to the map
        ...
        // Traverse the original list and set the arbit pointer of the copied nodes
        curr = head;
